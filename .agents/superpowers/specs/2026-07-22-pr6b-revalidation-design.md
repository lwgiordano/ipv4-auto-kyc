...
> `016` witness admission, `017` authority boundary, `018` transition authority, `019` payload repair, `020` redaction uniformity
> (all shipped), `021` 7b-activation (pending).
> **PR 6b is now migration `022` (`down_revision='021'`)
...
> blockers recorded as O1/O2/O3 in the activation spec (rev 12) that must be resolved before this
