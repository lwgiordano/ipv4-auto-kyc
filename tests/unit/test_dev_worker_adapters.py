...
`build_dev_adapters` wires the real Companies House, GLEIF and all five RIR RDAP strategies —
without it, the fixtures the app has always run on. Nothing else changes in either mode."""
